...
def init():
    ...
    env = fix_filepaths(dotenv_values("development_configs/demkit/lm_1_template.env"))
    subprocess.Popen(["python", "../implementation/local_monitor.py"],
                     env={
                         **os.environ,
                         **env,
                     })
    env = fix_filepaths(dotenv_values("development_configs/demkit/lm_2_template.env"))
    subprocess.Popen(["python", "../implementation/local_monitor.py"],
                     env={
                         **os.environ,
                         **env,
